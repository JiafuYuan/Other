...
namespace ThoughtWorks.QRCode.Codec
{
    public class QRCodeEncoder
    {
        ...
        {
            get { return qrcodeErrorCorrect; }
            set { qrcodeErrorCorrect = value; }
        }
        ...
        {
            get { return qrcodeEncodeMode; }
            set { qrcodeEncodeMode = value; }
        }

        virtual public int QRCodeScale
        {
            get { return qrCodeScale; }
            set { qrCodeScale = value; }
        }

        virtual public Color QRCodeBackgroundColor
        {
            get { return qrCodeBackgroundColor; }
            set { qrCodeBackgroundColor = value; }
        }

        virtual public Color QRCodeForegroundColor
        {
            get { return qrCodeForegroundColor; }
            set { qrCodeForegroundColor = value; }
        }
        ...
        public virtual bool[][] calQrcode(byte[] qrcodeData)
        {
            ...
            try
            {
                ...
                var resourceBytes = (byte[])Resources.ResourceManager.GetObject(fileName);
        ...
        public virtual bool[][] Encode(string content, Encoding encoding)
        {
            return calQrcode(encoding.GetBytes(content));
        }

        public bool[][] Encode(string content)
        {
