...
{
    public class AreaMonthReportController : Controller
    {
        ...
        public ActionResult GetGridList()
        {
            ...
            DataSet ds =bllHistoryRecord.GetAreaMonthReport(beginDate, endDate, areaName);
        ...
        public JsonResult GetReportData()
        {
            ...
            return DataTableToReportJson(dt, "AreaMonthReport");
        }
