...
{
	/// <summary>
	/// 数据访问类:m_ProductionPlanDAL
	/// </summary>
	public partial class m_ProductionPlanDAL
	{
		public m_ProductionPlanDAL()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BW.MMS.Model.m_ProductionPlanEntity model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into m_ProductionPlan(");
			strSql.Append("DeptID,Years,Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BW.MMS.Model.m_ProductionPlanEntity model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update m_ProductionPlan set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from m_ProductionPlan ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BW.MMS.Model.m_ProductionPlanEntity GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,DeptID,Years,Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec from m_ProductionPlan ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			BW.MMS.Model.m_ProductionPlanEntity model=new BW.MMS.Model.m_ProductionPlanEntity();
		...
		/// 得到一个对象实体
		/// </summary>
		public BW.MMS.Model.m_ProductionPlanEntity DataRowToModel(DataRow row)
		{
			BW.MMS.Model.m_ProductionPlanEntity model=new BW.MMS.Model.m_ProductionPlanEntity();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,DeptID,Years,Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec ");
			strSql.Append(" FROM m_ProductionPlan ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(string tabName, string date)
        {
            DataSet ds = DbHelperSQL.RunProcedure("p_Energy_Or_Production_Plan_Sel", new SqlParameter[] { new SqlParameter("@tabName", tabName), new SqlParameter("@Years", date) }, "tab", 300);
            return ds;
        }
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,DeptID,Years,Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec ");
			strSql.Append(" FROM m_ProductionPlan ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM m_ProductionPlan ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from m_ProductionPlan T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "m_ProductionPlan";
