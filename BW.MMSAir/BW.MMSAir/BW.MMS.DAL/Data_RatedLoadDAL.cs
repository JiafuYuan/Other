...
{
	/// <summary>
	/// 数据访问类:Data_RatedLoadDAL
	/// </summary>
	public partial class Data_RatedLoadDAL
	{
		public Data_RatedLoadDAL()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Data_RatedLoad"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from Data_RatedLoad");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Data_RatedLoad(");
			strSql.Append("AreaID,f_RatedLoad,f_RealLoad,dt_DateTime,vc_Memo,i_Flag)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@f_RealLoad", SqlDbType.Float,8),
			...
			parameters[2].Value = model.f_RealLoad;
			parameters[3].Value = model.dt_DateTime;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Data_RatedLoad set ");
			strSql.Append("AreaID=@AreaID,");
			strSql.Append("f_RatedLoad=@f_RatedLoad,");
			strSql.Append("f_RealLoad=@f_RealLoad,");
			strSql.Append("dt_DateTime=@dt_DateTime,");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Data_RatedLoad ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public BW.MMS.Model.Data_RatedLoadEntity GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,AreaID,f_RatedLoad,f_RealLoad,dt_DateTime,vc_Memo,i_Flag from Data_RatedLoad ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			BW.MMS.Model.Data_RatedLoadEntity model=new BW.MMS.Model.Data_RatedLoadEntity();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["f_RealLoad"]!=null && ds.Tables[0].Rows[0]["f_RealLoad"].ToString()!="")
				{
					model.f_RealLoad=decimal.Parse(ds.Tables[0].Rows[0]["f_RealLoad"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,AreaID,f_RatedLoad,f_RealLoad,dt_DateTime,vc_Memo,i_Flag ");
			strSql.Append(" FROM Data_RatedLoad ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,AreaID,f_RatedLoad,f_RealLoad,dt_DateTime,vc_Memo,i_Flag ");
			strSql.Append(" FROM Data_RatedLoad ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Data_RatedLoad T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Data_RatedLoad";
