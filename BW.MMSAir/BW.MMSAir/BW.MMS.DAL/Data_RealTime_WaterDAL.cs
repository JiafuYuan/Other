...
{
	/// <summary>
	/// 数据访问类:Data_RealTime_WaterDAL
	/// </summary>
	public partial class Data_RealTime_WaterDAL
	{
		public Data_RealTime_WaterDAL()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("SensorID", "Data_RealTime_Water"); 
		}
		...
		public bool Exists(int SensorID)
		{
			...
			strSql.Append("select count(1) from Data_RealTime_Water");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Data_RealTime_Water(");
			strSql.Append("SensorID,f_InstantaneousVelocity,f_InstantaneousFlowrate,f_PlusCumulativeFlowrate,f_MinusCumulativeFlowrate,f_IntegratingRunTime,vc_Memo,i_Flag)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Data_RealTime_Water set ");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@SensorID", SqlDbType.Int,4)};
			parameters[0].Value = model.f_InstantaneousVelocity;
			parameters[1].Value = model.f_InstantaneousFlowrate;
			parameters[2].Value = model.f_PlusCumulativeFlowrate;
			parameters[3].Value = model.f_MinusCumulativeFlowrate;
			parameters[4].Value = model.f_IntegratingRunTime;
			parameters[5].Value = model.vc_Memo;
			parameters[6].Value = model.i_Flag;
			parameters[7].Value = model.ID;
			parameters[8].Value = model.SensorID;
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Data_RealTime_Water ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public BW.MMS.Model.Data_RealTime_WaterEntity GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,SensorID,f_InstantaneousVelocity,f_InstantaneousFlowrate,f_PlusCumulativeFlowrate,f_MinusCumulativeFlowrate,f_IntegratingRunTime,vc_Memo,i_Flag from Data_RealTime_Water ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			BW.MMS.Model.Data_RealTime_WaterEntity model=new BW.MMS.Model.Data_RealTime_WaterEntity();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,SensorID,f_InstantaneousVelocity,f_InstantaneousFlowrate,f_PlusCumulativeFlowrate,f_MinusCumulativeFlowrate,f_IntegratingRunTime,vc_Memo,i_Flag ");
			strSql.Append(" FROM Data_RealTime_Water ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,SensorID,f_InstantaneousVelocity,f_InstantaneousFlowrate,f_PlusCumulativeFlowrate,f_MinusCumulativeFlowrate,f_IntegratingRunTime,vc_Memo,i_Flag ");
			strSql.Append(" FROM Data_RealTime_Water ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Data_RealTime_Water T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Data_RealTime_Water";
