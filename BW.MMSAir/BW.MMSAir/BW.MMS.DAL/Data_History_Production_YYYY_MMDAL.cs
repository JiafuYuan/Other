...
{
	/// <summary>
	/// 数据访问类:Data_History_Production_YYYY_MMDAL
	/// </summary>
	public partial class Data_History_Production_YYYY_MMDAL
	{
		public Data_History_Production_YYYY_MMDAL()
		{}
		#region  Method
		...
		public bool Exists(DateTime dt_DateTime)
		{
			...
			strSql.Append("select count(1) from Data_History_Production_YYYY_MM");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(BW.MMS.Model.Data_History_Production_YYYY_MMEntity model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Data_History_Production_YYYY_MM(");
			strSql.Append("dt_DateTime,SensorID,f_InstantaneousFlowrate,f_CumulativeTraffic,AreaID,DeptID,vc_Memo,i_Flag,dt_Now)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BW.MMS.Model.Data_History_Production_YYYY_MMEntity model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Data_History_Production_YYYY_MM set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Data_History_Production_YYYY_MM ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public BW.MMS.Model.Data_History_Production_YYYY_MMEntity GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,dt_DateTime,SensorID,f_InstantaneousFlowrate,f_CumulativeTraffic,AreaID,DeptID,vc_Memo,i_Flag,dt_Now from Data_History_Production_YYYY_MM ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			BW.MMS.Model.Data_History_Production_YYYY_MMEntity model=new BW.MMS.Model.Data_History_Production_YYYY_MMEntity();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,dt_DateTime,SensorID,f_InstantaneousFlowrate,f_CumulativeTraffic,AreaID,DeptID,vc_Memo,i_Flag,dt_Now ");
			strSql.Append(" FROM Data_History_Production_YYYY_MM ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,dt_DateTime,SensorID,f_InstantaneousFlowrate,f_CumulativeTraffic,AreaID,DeptID,vc_Memo,i_Flag,dt_Now ");
			strSql.Append(" FROM Data_History_Production_YYYY_MM ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Data_History_Production_YYYY_MM T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Data_History_Production_YYYY_MM";
