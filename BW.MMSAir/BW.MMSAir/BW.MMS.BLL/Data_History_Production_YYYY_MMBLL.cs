...
namespace BW.MMS.BLL
{
	...
	/// 产量历史数据表
	/// </summary>
	public partial class Data_History_Production_YYYY_MMBLL
	{
		private readonly BW.MMS.DAL.Data_History_Production_YYYY_MMDAL dal=new BW.MMS.DAL.Data_History_Production_YYYY_MMDAL();
		public Data_History_Production_YYYY_MMBLL()
		{}
		#region  Method
		/// <summary>
		/// 是否存在该记录
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Data_History_Production_YYYY_MMEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Data_History_Production_YYYY_MMEntity> DataTableToList(DataTable dt)
		{
			List<BW.MMS.Model.Data_History_Production_YYYY_MMEntity> modelList = new List<BW.MMS.Model.Data_History_Production_YYYY_MMEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BW.MMS.Model.Data_History_Production_YYYY_MMEntity model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new BW.MMS.Model.Data_History_Production_YYYY_MMEntity();
