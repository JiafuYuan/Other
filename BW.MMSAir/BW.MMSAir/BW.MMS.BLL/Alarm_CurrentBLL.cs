...
namespace BW.MMS.BLL
{
	...
	/// 实时告警数据表
	/// </summary>
	public partial class Alarm_CurrentBLL
	{
		private readonly BW.MMS.DAL.Alarm_CurrentDAL dal=new BW.MMS.DAL.Alarm_CurrentDAL();
		public Alarm_CurrentBLL()
		{}
		#region  Method
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Alarm_CurrentEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Alarm_CurrentEntity> DataTableToList(DataTable dt)
		{
			List<BW.MMS.Model.Alarm_CurrentEntity> modelList = new List<BW.MMS.Model.Alarm_CurrentEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BW.MMS.Model.Alarm_CurrentEntity model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new BW.MMS.Model.Alarm_CurrentEntity();
        ...
        {
            return dal.GetPagingList(alarmTypeID, page, rows, sort, order, out total);
        }
