...
namespace BW.MMS.BLL
{
	...
	/// 风量实时数据表
	/// </summary>
	public partial class Data_RealTime_WindBLL
	{
		private readonly BW.MMS.DAL.Data_RealTime_WindDAL dal=new BW.MMS.DAL.Data_RealTime_WindDAL();
		public Data_RealTime_WindBLL()
		{}
		#region  Method
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Data_RealTime_WindEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BW.MMS.Model.Data_RealTime_WindEntity> DataTableToList(DataTable dt)
		{
			List<BW.MMS.Model.Data_RealTime_WindEntity> modelList = new List<BW.MMS.Model.Data_RealTime_WindEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BW.MMS.Model.Data_RealTime_WindEntity model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new BW.MMS.Model.Data_RealTime_WindEntity();
