...
namespace DB_VehicleTransportManage.DAL
{
	...
	public partial class m_Department
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DB_VehicleTransportManage.Model.m_Department model)
		{
			...
			strSql.Append("insert into m_Department(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_VehicleTransportManage.Model.m_Department model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update m_Department set ");
			if (model.vc_Name != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from m_Department ");
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_Department GetModel(int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1  ");
			strSql.Append(" ID,vc_Name,ParentID,vc_Memo,i_Flag ");
			strSql.Append(" from m_Department ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.m_Department model=new DB_VehicleTransportManage.Model.m_Department();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_Department DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.m_Department model=new DB_VehicleTransportManage.Model.m_Department();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,vc_Name,ParentID,vc_Memo,i_Flag ");
			strSql.Append(" FROM m_Department ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM m_Department ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from m_Department T ");
