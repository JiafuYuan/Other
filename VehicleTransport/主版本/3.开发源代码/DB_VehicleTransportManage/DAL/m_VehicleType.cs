...
namespace DB_VehicleTransportManage.DAL
{
	...
	public partial class m_VehicleType
	{
		...
		public int Add(DB_VehicleTransportManage.Model.m_VehicleType model)
		{
			...
			strSql.Append("insert into m_VehicleType(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update m_VehicleType set ");
			if (model.vc_Name != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from m_VehicleType ");
		...
		public DB_VehicleTransportManage.Model.m_VehicleType GetModel(int ID)
		{
			...
			strSql.Append(" from m_VehicleType ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.m_VehicleType model=new DB_VehicleTransportManage.Model.m_VehicleType();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_VehicleType DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.m_VehicleType model=new DB_VehicleTransportManage.Model.m_VehicleType();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM m_VehicleType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from m_VehicleType T ");
