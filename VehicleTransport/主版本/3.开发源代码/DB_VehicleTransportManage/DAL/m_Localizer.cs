/**  版本信息模板在安装目录下，可自行修改。
* BW_KJ222.dbo.m_Localizer.cs
*
* 功 能： N/A
* 类 名： BW_KJ222.dbo.m_Localizer
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
namespace DB_VehicleTransportManage.DAL
{
	...
	public partial class m_Localizer
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DB_VehicleTransportManage.Model.m_Localizer model)
		{
			...
			strSql.Append("insert into BW_KJ222.dbo.m_Localizer(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_VehicleTransportManage.Model.m_Localizer model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BW_KJ222.dbo.m_Localizer set ");
			if (model.AreaID != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BW_KJ222.dbo.m_Localizer set i_flag=1 ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BW_KJ222.dbo.m_Localizer ");
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_Localizer GetModel(int ID)
		{
			StringBuilder strSql=new StringBuilder();
            ...
            strSql.Append(" from BW_KJ222.dbo.m_Localizer ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.m_Localizer model=new DB_VehicleTransportManage.Model.m_Localizer();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_Localizer DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.m_Localizer model=new DB_VehicleTransportManage.Model.m_Localizer();
			if (row != null)
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
		    ...
		    {
                strSql.Append(
                   " ID,AreaID,i_HID,i_Type,vc_Code,vc_Name,vc_Memo,i_Flag ");
		    }
		    strSql.Append(" FROM BW_KJ222.dbo.m_Localizer ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM BW_KJ222.dbo.m_Localizer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BW_KJ222.dbo.m_Localizer T ");
