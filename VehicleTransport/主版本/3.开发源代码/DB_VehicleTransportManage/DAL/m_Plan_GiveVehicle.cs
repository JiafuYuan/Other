...
namespace DB_VehicleTransportManage.DAL
{
	...
	public partial class m_Plan_GiveVehicle
	{
		...
		public int Add(DB_VehicleTransportManage.Model.m_Plan_GiveVehicle model)
		{
			...
			strSql.Append("insert into m_Plan_GiveVehicle(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update m_Plan_GiveVehicle set ");
			if (model.PlanID != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from m_Plan_GiveVehicle ");
		...
		public DB_VehicleTransportManage.Model.m_Plan_GiveVehicle GetModel(int ID)
		{
			...
			strSql.Append(" ID,PlanID,VehicleTypeID,i_Count,vc_Memo,i_Flag ");
			strSql.Append(" from m_Plan_GiveVehicle ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.m_Plan_GiveVehicle model=new DB_VehicleTransportManage.Model.m_Plan_GiveVehicle();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_Plan_GiveVehicle DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.m_Plan_GiveVehicle model=new DB_VehicleTransportManage.Model.m_Plan_GiveVehicle();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,PlanID,VehicleTypeID,i_Count,vc_Memo,i_Flag ");
			strSql.Append(" FROM m_Plan_GiveVehicle ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM m_Plan_GiveVehicle ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from m_Plan_GiveVehicle T ");
