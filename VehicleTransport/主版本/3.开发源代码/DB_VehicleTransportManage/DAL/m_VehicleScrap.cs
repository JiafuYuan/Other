...
{
	/// <summary>
	/// 数据访问类:m_VehicleScrap
	/// </summary>
	public partial class m_VehicleScrap
	{
		public m_VehicleScrap()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DB_VehicleTransportManage.Model.m_VehicleScrap model)
		{
			...
			strSql.Append("insert into m_VehicleScrap(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_VehicleTransportManage.Model.m_VehicleScrap model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update m_VehicleScrap set ");
			if (model.VehicleID != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from m_VehicleScrap ");
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_VehicleScrap GetModel(int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1  ");
			strSql.Append(" ID,VehicleID,dt_DateTime,PersonID,vc_Memo,i_Flag ");
			strSql.Append(" from m_VehicleScrap ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.m_VehicleScrap model=new DB_VehicleTransportManage.Model.m_VehicleScrap();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.m_VehicleScrap DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.m_VehicleScrap model=new DB_VehicleTransportManage.Model.m_VehicleScrap();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,VehicleID,dt_DateTime,PersonID,vc_Memo,i_Flag ");
			strSql.Append(" FROM m_VehicleScrap ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM m_VehicleScrap ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from m_VehicleScrap T ");
