...
namespace DB_VehicleTransportManage.DAL
{
	...
	public partial class data_VehicleAlarm
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DB_VehicleTransportManage.Model.data_VehicleAlarm model)
		{
			...
			strSql.Append("insert into data_VehicleAlarm(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DB_VehicleTransportManage.Model.data_VehicleAlarm model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update data_VehicleAlarm set ");
			if (model.i_AlarmType != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from data_VehicleAlarm ");
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.data_VehicleAlarm GetModel(int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1  ");
			strSql.Append(" ID,i_AlarmType,PlanID,VehicleID,i_IsPreAlarm,dt_Start,dt_End,vc_Memo,i_Flag ");
			strSql.Append(" from data_VehicleAlarm ");
			strSql.Append(" where ID="+ID+"" );
			DB_VehicleTransportManage.Model.data_VehicleAlarm model=new DB_VehicleTransportManage.Model.data_VehicleAlarm();
		...
		/// 得到一个对象实体
		/// </summary>
		public DB_VehicleTransportManage.Model.data_VehicleAlarm DataRowToModel(DataRow row)
		{
			DB_VehicleTransportManage.Model.data_VehicleAlarm model=new DB_VehicleTransportManage.Model.data_VehicleAlarm();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,i_AlarmType,PlanID,VehicleID,i_IsPreAlarm,dt_Start,dt_End,vc_Memo,i_Flag ");
			strSql.Append(" FROM data_VehicleAlarm ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM data_VehicleAlarm ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from data_VehicleAlarm T ");
