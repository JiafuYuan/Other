...
{
	/// <summary>
	/// m_MaterielType:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class m_MaterielType
	{
		...
		private string _vc_unit;
		private int? _parentid;
		private string _vc_specifications;
		...
		{
			set{ _vc_specifications=value;}
			get{return _vc_specifications;}
		}
		/// <summary>
		/// 
		/// </summary>
