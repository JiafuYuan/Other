...
public class LoadNFCActivity extends BasicTitleActivity {
	...
	public void stop(View view) { 
		...
		if(data==null||data.size()<1){
			...
			Toast.makeText(this, "未扫到车辆，请重新扫卡", 0).show();
		...
		Intent intent=new Intent(
				"com.bestway.kj915.activity.home.loadvehilce.LoadChooseActivity");
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View view = View.inflate(LoadNFCActivity.this,
	...
	public void onNewIntent(Intent intent) {
		...
		try {
			...
			Toast.makeText(LoadNFCActivity.this, "卡的内容格式错误", 0)
					.show();
			return;
		}
