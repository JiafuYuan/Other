...
public class MyDropdownBox extends RelativeLayout implements OnClickListener,
		OnItemClickListener {
	...
	public MyDropdownBox(Context context) {
		super(context);
		this.context = context;
		initView(context);
	}

	public MyDropdownBox(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initView(context);

		title_name = attrs.getAttributeValue(
				"http://schemas.android.com/apk/res/com.bestway.kj915", "name");
		size = attrs
				.getAttributeValue(
	...
	public MyDropdownBox(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		View.inflate(context, R.layout.mydropdownbox, this);
		...
		header = View.inflate(context,
				R.layout.mydropdownbox_list_header, null);
	}
		...
		if (pw == null) {
			...
			pw.setOnDismissListener(new OnDismissListener() {
				...
				public void onDismiss() {
					ib_arrow.setBackgroundResource(R.drawable.down_arrow1);
				}
			});
		}
	...
	class List_Item_Adapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			View view = View.inflate(context, R.layout.mydropdownbox_list_item,
					null);
