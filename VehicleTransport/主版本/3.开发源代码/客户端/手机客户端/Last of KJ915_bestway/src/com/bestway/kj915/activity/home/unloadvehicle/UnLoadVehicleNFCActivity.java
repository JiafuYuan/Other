...
public class UnLoadVehicleNFCActivity extends BasicTitleActivity {
	...
	public void onNewIntent(Intent intent) {
		...
		try {
			...
			Toast.makeText(UnLoadVehicleNFCActivity.this, "卡的内容格式错误", 0).show();
			return;
		}
		...
		Intent intent2 = new Intent(
				"com.bestway.kj915.activity.home.unloadvehicle.UnLoadVehicleActivity");
