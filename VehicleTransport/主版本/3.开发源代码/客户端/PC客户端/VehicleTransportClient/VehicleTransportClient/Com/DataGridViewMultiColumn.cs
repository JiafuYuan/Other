...
{
    public partial class DataGridViewMultiColumn : DataGridViewX
    {
        private TreeView treeView1 = new TreeView();

        public DataGridViewMultiColumn()
        {
            InitializeComponent();
        }

        public DataGridViewMultiColumn(IContainer container)
        {
            container.Add(this);
        ...
        public void PaintUnitHeader(TreeNode node, DataGridViewCellPaintingEventArgs e, int level)
        {
            ...
            //SolidBrush backColorBrush = new SolidBrush(Color.Red);
            //画矩形
