...
{
    public partial class FormHistoryNoChanageStateAlarm : Form
    {
        private EnumAlarmType _type;
        private string _tableName = "FormHistoryNoChanageStateAlarm";
        private int _selectIndex = -1;
        public FormHistoryNoChanageStateAlarm(EnumAlarmType type)
        {
            InitializeComponent();
            _type = type;
            ...
            Pub.StyleManager.SetGridStyle(_tableName, this.dgvList);
            this.Load += new EventHandler(FormHistoryNoChanageStateAlarm_Load);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void FormHistoryNoChanageStateAlarm_Load(object sender, EventArgs e)
        {
