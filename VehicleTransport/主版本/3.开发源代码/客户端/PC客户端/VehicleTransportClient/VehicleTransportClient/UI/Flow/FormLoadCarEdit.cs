...
{
    public partial class FormLoadCarEdit : Common.frmBase
    {
        ...
        int _personID = 0;
        public FormLoadCarEdit(Model.v_Plan vplanmodel)
        {
            InitializeComponent();
            _vplanmodel = vplanmodel;
            txtPlanCode.Text = _vplanmodel.vc_PlanCode;
        ...
        public Model.m_Plan GetModel()
        {
            ...
            _modelPlan.vc_PlanCode = txtPlanCode.Text.Trim();
