...
{
    public partial class FormHistoryScrapTimeOutAlarm : Form
    {
        private EnumAlarmType _type;
        private string _tableName = "FormHistoryScrapTimeOutAlarm";
        private int _selectIndex = -1;
        public FormHistoryScrapTimeOutAlarm(EnumAlarmType type)
        {
            InitializeComponent();
            _type = type;
            ...
            Pub.StyleManager.SetGridStyle(_tableName, this.dgvList);
            this.Load += new EventHandler(FormHistoryScrapTimeOutAlarm_Load);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void FormHistoryScrapTimeOutAlarm_Load(object sender, EventArgs e)
        {
