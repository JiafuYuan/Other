...
{
    public partial class FormHistoryNoUseAlarm : Form
    {
        private EnumAlarmType _type;
        private string _tableName = "FormHistoryNoUseAlarm";
        private int _selectIndex = -1;
        public FormHistoryNoUseAlarm(EnumAlarmType type)
        {
            InitializeComponent();
            _type = type;
            ...
            Pub.StyleManager.SetGridStyle(_tableName, this.dgvList);
            this.Load += new EventHandler(FormHistoryNoUseAlarm_Load);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void FormHistoryNoUseAlarm_Load(object sender, EventArgs e)
        {
        ...
        public void LoadHistoryAlarmData(string dtStart, string dtStop)
        {
            ...
            {
                int i = dgvList.Rows.Add(item.vc_Code,item.vc_Name,
