...
{
    public partial class FormHistoryRunDerictionAlarm : Form
    {
        private EnumAlarmType _type;
        private string _tableName = "FormHistoryRunDerictionAlarm";
        private int _selectIndex = -1;
        public FormHistoryRunDerictionAlarm(EnumAlarmType type)
        {
            InitializeComponent();
            _type = type;
            ...
            Pub.StyleManager.SetGridStyle(_tableName, this.dgvList);
            this.Load += new EventHandler(FormHistoryRunDerictionAlarm_Load);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void FormHistoryRunDerictionAlarm_Load(object sender, EventArgs e)
        {
        ...
        public void LoadHistoryAlarmData(string dtStart, string dtStop)
        {
            ...
            {
                int i = dgvList.Rows.Add(item.vc_PlanCode,item.vc_Code, item.vc_Name,
