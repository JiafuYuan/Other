...
{
    public partial class FormSupplyCarEdit : Common.frmBase
    {
        ...
        int _personID = 0;
        public FormSupplyCarEdit(Model.v_Plan vplanmodel)
        {
            InitializeComponent();
        ...
        private void FormSupplyCarEdit_Load(object sender, EventArgs e)
        {
            InitGrid(null);
        }
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                Common.MessageBoxEx.MessageBoxEx.Show("请选择要取消申请的物料类型", "提示", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
