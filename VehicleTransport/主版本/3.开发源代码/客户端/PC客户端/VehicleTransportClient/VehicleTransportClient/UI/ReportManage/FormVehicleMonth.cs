...
{
    public partial class FormVehicleMonth : Form
    {
        private string _tableName = "FormVehicleMonth";
        ...
        public void LoadData(string dtStart)
        {
            ...
            dataSet = bllVehicle.RunProUpdate(dtStart);
            ...
            if (dataSet != null && dataSet.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    dgvList.Rows.Add(dataSet.Tables[0].Rows[i]["vc_Code"], dataSet.Tables[0].Rows[i]["vc_Name"], dataSet.Tables[0].Rows[i]["VehicleCount"]);
                }
        ...
        {
            acNetUtilsManage.Init(System.Windows.Forms.Application.StartupPath + "\\Report", "VehicleMonth.apt");
            acNetUtilsManage.FillDatasetToAC(dataSet, "VehicleMonth");
        ...
        {
            if (acNetUtilsManage.Init(System.Windows.Forms.Application.StartupPath + "\\Report", "VehicleMonth.apt"))
            {
