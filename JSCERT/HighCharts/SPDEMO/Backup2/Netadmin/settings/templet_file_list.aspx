<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templet_file_list.aspx.cs" Inherits="SPcms.Web.admin.settings.templet_file_list" %>
    ...
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','此操作将会彻底删除文件，确定要继续吗？');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
          <li> <asp:LinkButton ID="btnsc" runat="server" CssClass="folder" 
                            onclick="btnsc_Click"><i></i><span>生成当前模板</span></asp:LinkButton></li>
      </ul>
    </div>
  </div>
</div>
