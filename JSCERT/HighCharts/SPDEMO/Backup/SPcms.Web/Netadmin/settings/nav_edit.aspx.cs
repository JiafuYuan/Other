    ...
    public partial class nav_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind(SPEnums.NavigationEnum.System.ToString()); //绑定导航菜单
        ...
        private void ShowInfo(int _id)
        {
           ...
           // Model.manager model2 = GetAdminInfo();
            //if (model.is_sys == 1 )
            //{
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                model.nav_type = SPEnums.NavigationEnum.System.ToString();
                ...
                if (bll.Add(model) > 0)
                {
                    AddAdminLog(SPEnums.ActionEnum.Add.ToString(), "添加导航信息:" + model.title); //记录日志
                    return true;
                }
            }
            catch
        ...
        private bool DoEdit(int _id)
        {
            try
            {
                ...
                if (bll.Update(model))
                {
                    AddAdminLog(SPEnums.ActionEnum.Add.ToString(), "修改导航信息:" + model.title); //记录日志
                    return true;
                }
            }
            catch
