...
{
    public partial class css_file_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(string _path)
        {
            ...
            {
                txtContent.Value = objReader.ReadToEnd();
                objReader.Close();
            }

            //获取所有的频道
            repds.DataSource = new BLL.channel().GetList(100, "1=1", "sort_id");
            repds.DataBind();
            RptBind();
        }
        #endregion
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Byte[] info = Encoding.UTF8.GetBytes(txtContent.Value);
