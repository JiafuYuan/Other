...
using SPcms.API.Payment.Tenpay;
using SPcms.Common;

namespace SPcms.Web.api.payment.tenpay
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = SPRequest.GetFormString("pay_order_no").ToUpper(); //订单号
            decimal order_amount = SPRequest.GetFormDecimal("pay_order_amount", 0); //订单金额
            string user_name = SPRequest.GetFormString("pay_user_name"); //支付用户名
            string subject = SPRequest.GetFormString("pay_subject"); //备注说明
