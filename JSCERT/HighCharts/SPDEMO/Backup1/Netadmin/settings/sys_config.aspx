<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="SPcms.Web.admin.settings.sys_config"
...
<body class="mainbody">
    ...
    <div class="tab-content">
        ...
        <dl>
            <dt>网站名称(英文)</dt>
            <dd>
                <asp:TextBox ID="webename" runat="server" CssClass="input normal" />
                <span class="Validform_checktip">*任意字符，控制在255个字符内</span>
            </dd>
        </dl>
        <dl>
        ...
        <dl>
            <dt>首页英文标题(SEO)</dt>
            <dd>
                <asp:TextBox ID="webetitle" runat="server" CssClass="input normal" />
                <span class="Validform_checktip">*自定义的英文首页标题</span>
            </dd>
        </dl>
        <dl>
            <dt>页面英文关健词(SEO)</dt>
            <dd>
                <asp:TextBox ID="webekeyword" runat="server" CssClass="input normal" />
                <span class="Validform_checktip">英文页面关键词(keyword)</span>
            </dd>
        </dl>
        <dl>
            <dt>页面英文描述(SEO)</dt>
            <dd>
                <asp:TextBox ID="webedescription" runat="server" CssClass="input normal" />
                <span class="Validform_checktip">英文页面描述(description)</span>
            </dd>
        </dl>
        <dl>
            <dt>网站版权信息</dt>
    ...
    <div class="tab-content" style="display: none">
        <dl>
            <dt>删除图片</dt>
            <dd>
                <asp:Button ID="btnDelImg" runat="server" Text="删除图片" CssClass="btn" OnClick="btnDelImg_Click" />
                <span class="Validform_checktip">*在网站中匹配，如本地图片不在网站中，则删除，删除后无法恢复 仅支持 jpg jpge png gif 格式</span>
            </dd>
        </dl>
        <dl>
            <dt>网站安装目录</dt>
        ...
        <dl>
            <dt>手机网站域名</dt>
            <dd>
                <asp:TextBox ID="mobiledomain" runat="server" CssClass="input txt" datatype="/^\s*$|^([a-zA-Z0-9\-\u4e00-\u9fa5]+\.)+[a-zA-Z\u4e00-\u9fa5]+$/"
                    errormsg="请输入正确的域名！" sucmsg=" " />
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-checkbox">
                    <asp:CheckBox ID="Bilingualstat" runat="server" />
                </div>
                <span class="Validform_checktip">*开启后可以开发英文频道</span>
            </dd>
        </dl>
        <dl>
            <dt>开启评论审核</dt>
    ...
    <div class="tab-content" style="display: none">
        <dl>
            ...
            <dd>
                ...
                <span class="Validform_checktip">尚未申请？<a href="http://sms.SPcms.net" target="_blank">请点击这里注册</a></span>
            </dd>
        </dl>
        <dl>
            <dt>短信API地址</dt>
        ...
        <dl>
            ...
            <dd>
                ...
                如果您尚未申请开通，<a href="http://sms.SPcms.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
            </dd>
        </dl>
    </div>
    <!--/手机短信设置-->
    ...
    <div class="tab-content" style="display: none">
        ...
        <dl>
            <dt>文件上传类型</dt>
            <dd>
                <asp:TextBox ID="fileextension" runat="server" CssClass="input normal" datatype="*1-255"
                    sucmsg=" " />
