<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="SPcms.Web.admin.users.message_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="message_edit.aspx?action=<%=SPEnums.ActionEnum.Add %>"><i></i><span>发送消息</span></a></li>
