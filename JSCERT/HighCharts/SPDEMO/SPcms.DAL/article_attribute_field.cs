...
namespace SPcms.DAL
{
    ...
    public partial class article_attribute_field
    {
        ...
        public int Add(Model.article_attribute_field model)
        {
            ...
            strSql.Append("name,title,control_type,data_type,data_length,data_place,item_option,default_value,is_required,is_password,is_html,editor_type,valid_tip_msg,valid_error_msg,valid_pattern,sort_id,catename,channel_categoryid,is_sys,is_sort)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@channel_categoryid", SqlDbType.Int,4),
					new SqlParameter("@is_sys", SqlDbType.TinyInt,1),
                    new SqlParameter("@is_sort", SqlDbType.TinyInt,1),
            ...
            parameters[16].Value = model.catename;
            parameters[17].Value = model.channel_categoryid;
            parameters[18].Value = model.is_sys;
            parameters[19].Value = model.is_sort;
        ...
        /// 增加一条数据 加重载让返回新加的id
        /// </summary>
        public int Add(Model.article_attribute_field model,bool flag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into " + databaseprefix + "article_attribute_field(");
            strSql.Append("name,title,control_type,data_type,data_length,data_place,item_option,default_value,is_required,is_password,is_html,editor_type,valid_tip_msg,valid_error_msg,valid_pattern,sort_id,catename,channel_categoryid,is_sys,is_sort)");
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("channel_categoryid=@channel_categoryid,");
                        strSql.Append("is_sys=@is_sys,");
                        strSql.Append("is_sort=@is_sort");
                        strSql.Append(" where id=@id");
                        SqlParameter[] parameters = {
					            new SqlParameter("@id", SqlDbType.Int,4),
					            new SqlParameter("@name", SqlDbType.NVarChar,100),
                        ...
                        parameters[17].Value = model.catename;
                        parameters[18].Value = model.channel_categoryid;
                        parameters[19].Value = model.is_sys;
                        parameters[20].Value = model.is_sort;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,name,title,control_type,data_type,is_sort,data_length,data_place,item_option,default_value,is_required,is_password,is_html,editor_type,valid_tip_msg,valid_error_msg,valid_pattern,sort_id,is_sys,catename,channel_categoryid");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["is_sort"].ToString() != "")
                {
                    model.is_sys = int.Parse(ds.Tables[0].Rows[0]["is_sort"].ToString());
                }
                if (ds.Tables[0].Rows[0]["channel_categoryid"].ToString() != "")
                {
                    model.channel_categoryid = int.Parse(ds.Tables[0].Rows[0]["channel_categoryid"].ToString());
                }
