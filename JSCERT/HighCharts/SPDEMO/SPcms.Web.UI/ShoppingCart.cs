...
namespace SPcms.Web.UI
{
    ...
    public partial class ShopCart
    {
        ...
        public static void Clear(string Key)
        {
            ...
            {
                Utils.WriteCookie(SPKeys.COOKIE_SHOPPING_CART, "", -43200);
            }
            else
            {
                IDictionary<string, int> dic = GetCart();
        ...
        {
            Utils.WriteCookie(SPKeys.COOKIE_SHOPPING_CART, strValue, 43200); //存储一个月
        }
        ...
        {
            return Utils.GetCookie(SPKeys.COOKIE_SHOPPING_CART);
        }
