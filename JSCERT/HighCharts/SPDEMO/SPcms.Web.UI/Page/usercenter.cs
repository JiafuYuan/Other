...
namespace SPcms.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[SPKeys.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(SPKeys.COOKIE_USER_NAME_REMEMBER, "SPcms", -43200);
                Utils.WriteCookie(SPKeys.COOKIE_USER_PWD_REMEMBER, "SPcms", -43200);
                Utils.WriteCookie("UserName", "SPcms", -1);
                Utils.WriteCookie("Password", "SPcms", -1);
                //自动登录,跳转URL
