...
namespace SPcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected string getlinkcode()
        {
            return new BLL.user_code().getlinkcode().Replace("{config.remoturl}", config.remoturl);
        }
        ...
        {
            string _where = "type='" + SPEnums.CodeEnum.Register.ToString() + "'";
            if (!string.IsNullOrEmpty(strwhere))
            {
                _where += " and " + strwhere;
            }
