<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mappc.aspx.cs" Inherits="SPcms.Web.Plugin.map.admin.mappc" %>
...
<script type="text/javascript">
    ...
    function savedata() {
        ...
        $.post("../ajax.ashx?action=edit_map", { address: $("#address").val(), cname: $("#cname").val(), tel: $("#tel").val(), seojj: $("#content").val(), mwidth: $("#mwidth").val(), mheight: $("#mheight").val() }, function (data, textStatus) {
