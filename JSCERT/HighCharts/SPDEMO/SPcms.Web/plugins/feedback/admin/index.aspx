<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SPcms.Web.Plugin.Feedback.admin.index" %>
    ...
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
           <li><a class="folder" href="cate_list.aspx" ><i></i><span>分类管理</span></a></li>
      </ul>
    </div>
    <div class="r-list">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="8%">选择</th>
    <th align="left">标题</th>
    <th width="16%" align="left">联系人</th>
    <th width="16%" align="left">分类</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("user_name")%></td>
      <td><%#getcatename(Eval("cateid").ToString())%></td>
