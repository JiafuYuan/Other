...
namespace SPcms.Web.Plugin.Feedback.admin
{
    public partial class index : SPcms.Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("plugin_feedback", SPEnums.ActionEnum.Audit.ToString()); //检查权限
            BLL.feedback bll = new BLL.feedback();
            ...
            AddAdminLog(SPEnums.ActionEnum.Audit.ToString(), "审核留言插件内容"); //记录日志
