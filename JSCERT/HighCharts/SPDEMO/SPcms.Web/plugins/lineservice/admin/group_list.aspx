<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_list.aspx.cs" Inherits="SPcms.Web.Plugin.LineService.admin.group_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="group_edit.aspx?action=<%=SPEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="group_edit.aspx?action=<%#SPEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    <td><%# Convert.ToInt32(Eval("default_view")) == 1 ? "是" : "否"%></td>
    <td align="center"><%#Eval("sort_id")%></td>
    <td align="center">
      <%# Convert.ToInt32(Eval("is_lock")) == 0 ? "显示" : "关闭"%>
    </td>
    <td align="center"><a href="group_edit.aspx?action=<%#SPEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
