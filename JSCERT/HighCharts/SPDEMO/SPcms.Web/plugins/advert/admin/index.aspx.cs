...
namespace SPcms.Web.Plugin.Advert.admin
{
    public partial class index : SPcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.property = SPRequest.GetQueryString("property");
            this.pageSize = GetPageSize(10); //每页数量
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("plugin_advert_adv", SPEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("plugin_advert_adv", SPEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.advert bll = new BLL.advert();
            ...
            AddAdminLog(SPEnums.ActionEnum.Delete.ToString(), "删除广告位成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
