...
namespace SPcms.Web.admin.settings
{
    public partial class url_rewrite_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel = SPRequest.GetQueryString("channel");
            this.type = SPRequest.GetQueryString("type");
        ...
        {
            ChkAdminLevel("site_url_rewrite", SPEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(SPEnums.ActionEnum.Delete.ToString(), "删除URL配置信息"); //记录日志
