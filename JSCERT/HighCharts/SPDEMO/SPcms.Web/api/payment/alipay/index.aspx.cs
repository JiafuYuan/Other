...
namespace SPcms.Web.api.payment.alipay
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = SPRequest.GetFormString("pay_order_no").ToUpper();
            decimal order_amount = SPRequest.GetFormDecimal("pay_order_amount", 0);
            string user_name = SPRequest.GetFormString("pay_user_name");
            string subject = SPRequest.GetFormString("pay_subject");
            //以下收货人信息
            ...
            if (Config.Type == "1") //即时到帐
            {
                ...
                sParaTemp.Add("exter_invoke_ip", SPRequest.GetIP()); ////获取客户端的IP地址
