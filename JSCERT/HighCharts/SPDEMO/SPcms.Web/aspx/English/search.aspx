...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <div class=\"nmain clearfix\">\r\n        <div class=\"naside float_l\">\r\n            <h5>\r\n                产品目录</h5>\r\n        </div>\r\n        <div class=\"nmainbox float_r\">\r\n            <small>当前位置：<a href=\"");
	templateBuilder.Append(linkurl("index"));

	templateBuilder.Append("\">首页</a> - 搜索关健字：");
	templateBuilder.Append(Utils.ObjectToStr(keyword));
	templateBuilder.Append(" 共有 <b class=\"red\">");
	templateBuilder.Append(Utils.ObjectToStr(totalcount));
	templateBuilder.Append("</b> 条记录</small></div>\r\n    </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\">\r\n    </div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n        <!--产品分类-->\r\n        ");
	...
	templateBuilder.Append("\r\n                    <li class=\"clearfix\"><a class=\"float_l\" href=\"" + Utils.ObjectToStr(dr["link_url"]) + "\">&gt;&gt;\r\n                        " + Utils.ObjectToStr(dr["title"]) + "</a><span class=\"float_r\">[");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy-MM-dd"));
