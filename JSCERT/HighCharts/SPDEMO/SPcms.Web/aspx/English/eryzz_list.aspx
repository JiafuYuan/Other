...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(category_id,"HONNER");
	...
	templateBuilder.Append("\">HOME</a> - HONNER</small></div>\r\n        </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\"></div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n    	<!--产品分类-->\r\n    \r\n               ");
	...
	DataTable news_list = get_article_list("eryzz", category_id, page, "status=0", out totalcount, out pagelist, "eryzz_list", category_id, "__id__");

	foreach(DataRow dr in news_list.Rows)
	{

	templateBuilder.Append("\r\n\r\n                    <dl>\r\n                        <dt><a href=\"");
	templateBuilder.Append(linkurl("eryzz_show",Utils.ObjectToStr(dr["id"])));
