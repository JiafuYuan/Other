...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(category_id,"NEWS");
	...
	templateBuilder.Append("\">HOME</a> - NEWS</small></div>\r\n        </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\"></div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n    	<!--产品分类-->\r\n    	");
	...
	DataTable news_list = get_article_list("enews", category_id, page, "status=0", out totalcount, out pagelist, "news_list", category_id, "__id__");

	foreach(DataRow dr in news_list.Rows)
	{

	templateBuilder.Append("\r\n  <li class=\"clearfix\"><a class=\"float_l\" href=\"");
	templateBuilder.Append(linkurl("enews_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">&gt;&gt; " + Utils.ObjectToStr(dr["title"]) + "</a><span class=\"float_r\">[");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy-MM-dd"));
