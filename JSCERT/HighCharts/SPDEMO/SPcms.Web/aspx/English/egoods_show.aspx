...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"news");
	...
	templateBuilder.Append(linkurl("enews_list","0"));

	templateBuilder.Append("\">news</a> - DETAIL</small></div>\r\n        </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\"></div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n    	<!--产品分类-->\r\n    ");
	...
	templateBuilder.Append(get_prevandnext_article("egoods_show",-1,"无上一条",0).ToString());

	templateBuilder.Append("</div>\r\n                <div>next：");
	templateBuilder.Append(get_prevandnext_article("egoods_show",1,"无下一条",0).ToString());
