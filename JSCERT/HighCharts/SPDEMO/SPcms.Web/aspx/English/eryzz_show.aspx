...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"HONNER");
	...
	templateBuilder.Append(" - ");
	templateBuilder.Append(Utils.ObjectToStr(config.webename));
	...
	templateBuilder.Append("\">HOME</a> - <a href=\"");
	templateBuilder.Append(linkurl("eryzz_list","0"));

	templateBuilder.Append("\">HONNER</a> - DETAIL</small></div>\r\n        </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\"></div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n    	<!--产品分类-->\r\n    ");
	...
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("</h4>\r\n                <div class=\"time2\"><span>posttime：");
	templateBuilder.Append(Utils.ObjectToStr(model.add_time));
	templateBuilder.Append("</span>&nbsp;&nbsp;<span>hots：<script type=\"text/javascript\" src=\"");
	...
	templateBuilder.Append("</p>\r\n            </div>\r\n            <div class=\"clear\"></div>\r\n            <!--分页-->\r\n            <div class=\"fanye float_r\">\r\n                <div>pre：");
	templateBuilder.Append(get_prevandnext_article("eryzz_show",-1,"无上一条",0).ToString());

	templateBuilder.Append("</div>\r\n                <div>next：");
	templateBuilder.Append(get_prevandnext_article("eryzz_show",1,"无下一条",0).ToString());
