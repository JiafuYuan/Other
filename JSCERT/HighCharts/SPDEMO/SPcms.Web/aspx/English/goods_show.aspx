...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\">产品展厅</a> - 详细信息</small></div>\r\n        </div>\r\n    </div>\r\n    <!--大图结束-->\r\n    <div class=\"clear\"></div>\r\n    <div id=\"nmainbody\" class=\"clearfix\">\r\n    	<!--产品分类-->\r\n    ");
	...
	templateBuilder.Append("script></span></div>\r\n                <div class=\"pic_cp\" align=\"center\"><a href=\"#\"><img src=\"");
	templateBuilder.Append(Utils.ObjectToStr(model.img_url));
	templateBuilder.Append("\" /></a></div>\r\n            </div>\r\n            <div class=\"clear\"></div>\r\n            <div class=\"nrr\">\r\n                <p>");
	templateBuilder.Append(Utils.ObjectToStr(model.content));
	templateBuilder.Append("</p>\r\n            </div>\r\n            <div class=\"clear\"></div>\r\n            <!--分页-->\r\n            <div class=\"fanye float_r\">\r\n                <div>上一篇文章：");
	templateBuilder.Append(get_prevandnext_article("goods_show",-1,"无上一条",0).ToString());

	templateBuilder.Append("</div>\r\n                <div>下一篇文章：");
	templateBuilder.Append(get_prevandnext_article("goods_show",1,"无下一条",0).ToString());
