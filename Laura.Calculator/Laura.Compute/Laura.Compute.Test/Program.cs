...
namespace Laura.Compute.Test
{
    public class Program
    {
        ...
        {
            ////预执行 //
            ExpressSchema expressSchema = ExpressSchema.Create("\"AABBCC\" LIKE \"%BB%\" AND 300>100 AND -0.000021323E+12 OR 34.543 AND True OR false AND 5697.000021323E+12 OR -45678.424123 AND [FName] IN (\"ShuXiaolong\",\"QuFuli\")");
        ...
        public static void TestSingleArgumentExpress02()
        {
            ...
            object value = ComputeHelper.ComputePropertyValue(new List<string> { "ShuXiaolong", "QuFuli" }, "1");
            Console.WriteLine(value);
        ...
        public static void TestNormalExpress04()
        {
            ...
            object result = ActionCounter(20000, () =>
            {
                object value = ComputeHelper.Compute("LEN(\"ShuXiaolong\"+\"QuFuli\")");                                         
                return value;
            });
        ...
        private static DataSet GetTableRecord()
        {
            ...
            using (SqlConnection conn = new SqlConnection("Data Source=localhost;Initial Catalog=MyWord;User Id=sa; Pwd=dc7e150683;"))
            {
    ...
    public class MyIndex
    {
        public string this[string index]
        {
            get {
                ...
                else if (index == "QFL") return "QuFuli";
                return string.Empty;
            }
        }
