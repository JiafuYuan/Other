<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.UI.Page.index"
...
<script runat="server">
    override protected void OnInit(EventArgs e)
    {
        ...
        */
        ...
        templateBuilder.Append("\">期货感悟</a>\r\n          <a href=\"");
   
        templateBuilder.Append(linkurl("video"));

        templateBuilder.Append("\">期货视频</a>\r\n     " );


      // templateBuilder.Append("  <a href=\"");
        templateBuilder.Append("  </p>\r\n      </div>\r\n    <div class=\"search\">\r\n ");
        templateBuilder.Append("<input id=\"keywords\" name=\"keywords\" class=\"input\" type=\"text\" onkeydown=\"if(event.keyCode==13){SiteSearch('");
        ...
        templateBuilder.Append(" 苏ICP备11073024号-1");
        

        templateBuilder.Append(" </p>\r\n    <p>Copyright &copy; 2009-2015 531d.com Corporation,All Rights Reserved.</p>\r\n    <p><script src=\"http://s24.cnzz.com/stat.php?id=111111111&show=pic\" language=\"javascript\"></");
